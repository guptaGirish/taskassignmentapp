...
@ServiceInfo(uri="/async/getfulltask")
public class AsyncGetFullTaskWithServerId implements MobileServiceBean
{
	private static Logger log = Logger.getLogger(AsyncGetFullTaskWithServerId.class);
	DeviceDetailsDS ds;
	...
	public AsyncGetFullTaskWithServerId()
	{
