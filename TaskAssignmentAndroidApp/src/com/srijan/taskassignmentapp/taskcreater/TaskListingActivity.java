...
public class TaskListingActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		taskList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> listView, View arg1, int position,
				...
				Intent i = new Intent(activity, FullTaskDetailActivity.class);
	...
	public void postCheckoutProcessing()
	{
		//showTaskList();
		initializeHandler();
		LoadCreatedTaskListAsyncTask l = new LoadCreatedTaskListAsyncTask(this, handler);
		l.execute();
	}
