...
public class LoadAssignedTaskListAsyncTask extends AsyncTask<Void,Void,Void>{
	Context context;
	...
	public LoadAssignedTaskListAsyncTask(Context context,Handler handler){
	...
	{
		Request request = new Request("/async/assignedtasklist");
